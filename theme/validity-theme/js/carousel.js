...
define([
	...
	function Carousel(options) {
	    ...
	    var el = document.getElementsByClassName(options.elem || 'carousel')[0],
	    ...
	    */
	    function currentDot() {
	        ...
	        el.className = defaultClassName + ' viewing-' + current;
